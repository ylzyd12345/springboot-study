...
# -*- coding: utf-8 -*-
"""
从 junmo-platform-common 模块迁移 util 目录的类到 junmo-common 模块
"""
...
# 源模块路径
SOURCE_BASE = r"F:\codes\roadmap\github-project\springboot-study\junmo-platform\junmo-platform-common\src\main\java\com\kev1n\junmo-platform\common"
...
def migrate_file(relative_path):
    ...
    content = content.replace(
        'com.junmo.junmo-platform.common',
    ...
    # 替换类引用
    content = re.sub(
        r'com\.kev1n\.junmo-platform\.(common|base)\.',
...
def main():
    """主函数"""
    print("开始迁移 junmo-platform-common 的 util 到 junmo-common...")
