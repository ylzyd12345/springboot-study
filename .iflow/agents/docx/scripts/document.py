...
class DocxXMLEditor(XMLEditor):
    ...
    def __init__(
        self, xml_path, rsid: str, author: str = "iFlow CLI", initials: str = "IC"
    ):
        ...
        Args:
            ...
            author: Author name for tracked changes and comments (default: "iFlow CLI")
            initials: Author initials (default: "IC")
        """
...
class Document:
    ...
    def __init__(
        ...
        Args:
            ...
            author: Default author name for comments (default: "iFlow CLI")
            initials: Default author initials for comments (default: "IC")
        """
