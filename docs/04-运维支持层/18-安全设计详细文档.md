# Spring4demo 安全设计详细文档

## 📋 文档信息

| 项目 | 内容 |
|------|------|
| **文档名称** | Spring4demo 安全设计详细文档 |
| **版本号** | v1.0.0 |
| **创建日期** | 2025-12-24 |
| **作者** | 安全架构师 |
| **审核人** | 首席安全官 |
...
public class MfaSecurityConfig {
    ...
    public MfaAuthenticationFilter mfaAuthenticationFilter() {
        return new MfaAuthenticationFilter();
    }
}
...
public class CorsConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOriginPatterns(Arrays.asList(
            "https://admin.spring4demo.com",
            "https://app.spring4demo.com"
        ));
...
logging:
  level:
    ...
    com.kev1n.spring4demo.security: DEBUG
