...
本文档详细说明 Junmo Platform 项目的测试框架、测试策略和最佳实践。
...
**存放位置**：`Junmo Platform-integration` 模块

## 4. 测试配置

### 4.1 测试配置文件

**core 模块**：`Junmo Platform-core/src/test/resources/application-test.yml`
...
**web 模块**：`Junmo Platform-web/src/test/resources/application-test.yml`
...
**位置**：`Junmo Platform-core/src/test/resources/db/schema.sql`
...
`Junmo Platform-core/src/test/java/.../service/impl/UserServiceImplTest.java`

### 10.2 Controller 层集成测试

`Junmo Platform-web/src/test/java/.../controller/UserControllerIT.java`

### 10.3 文件存储服务测试

`Junmo Platform-core/src/test/java/.../service/impl/FileStorageServiceImplTest.java`
