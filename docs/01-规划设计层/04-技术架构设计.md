...
graph LR
    ...
    subgraph "数据技术栈"
        C1[MySQL 8.0] --> C2[HikariCP]
        C3[Redis 7.0] --> C4[Lettuce]
        C5[MongoDB 6.0] --> C6[Spring Data]
        C7[Elasticsearch 8.0] --> C8[Spring Data ES]
    end
...
graph TB
    subgraph "认证层"
        A1[用户认证] --> A2[JWT Token]
        A3[OAuth2] --> A4[Authorization Server]
        A5[SSO] --> A6[Single Sign-On]
    end
