...
public interface CacheConstants {
    ...
    interface TOKEN {
        ...
        /**
         * 用户Token缓存key
         * 格式: junmo:token:{userId}
         */
        String USER_TOKEN_KEY = KEY_PREFIX + DELIMITER + "user";

        /**
         * Token黑名单key
         * 格式: junmo:token:blacklist:{token}
         */
    ...
    interface PERMISSION {
        ...
        /**
         * 用户权限缓存key
         * 格式: junmo:permission:user:{userId}
         */
        String USER_PERMISSION_KEY = KEY_PREFIX + DELIMITER + "user";

        /**
         * 角色权限缓存key
         * 格式: junmo:permission:role:{roleId}
         */
    ...
    interface CAPTCHA {
        ...
        /**
         * 登录验证码缓存key
         * 格式: junmo:captcha:login:{uuid}
         */
        String LOGIN_KEY = KEY_PREFIX + DELIMITER + "login";

        /**
         * 邮箱验证码缓存key
         * 格式: junmo:captcha:email:{email}
         */
        String EMAIL_KEY = KEY_PREFIX + DELIMITER + "email";

        /**
         * 手机验证码缓存key
         * 格式: junmo:captcha:phone:{phone}
         */
        String PHONE_KEY = KEY_PREFIX + DELIMITER + "phone";
    ...
    interface RATE_LIMIT {
        ...
        /**
         * API限流缓存key
         * 格式: junmo:ratelimit:api:{apiPath}
         */
        String API_KEY = KEY_PREFIX + DELIMITER + "api";

        /**
         * 用户限流缓存key
         * 格式: junmo:ratelimit:user:{userId}
         */
        String USER_KEY = KEY_PREFIX + DELIMITER + "user";

        /**
         * IP限流缓存key
         * 格式: junmo:ratelimit:ip:{ip}
         */
