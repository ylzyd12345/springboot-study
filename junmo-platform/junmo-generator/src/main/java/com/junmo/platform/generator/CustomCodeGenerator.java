...
public class CustomCodeGenerator {
    ...
    public static class GeneratorProperties {
         ...
         * 作者名称
         */
        private String author = "junmo-platform";

        /**
         * 父包名
         */
        private String parentPackage = "com.junmo.platform";
         ...
         * 输出目录
         */
        private String outputDir = System.getProperty("user.dir") + "/junmo-generator/src/main/java";

        /**
         * Mapper XML输出目录
         */
        private String mapperXmlPath = System.getProperty("user.dir") + "/junmo-model/src/main/resources/mapper";
