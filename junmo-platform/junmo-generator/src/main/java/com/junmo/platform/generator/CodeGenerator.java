        ...
        public void run(String... args) {
            ...
            FastAutoGenerator.create(url, username, password)
                    .globalConfig(builder -> {
                        builder.author("junmo-platform") // 设置作者
                                .enableSwagger() // 开启 swagger 模式
                                .outputDir(System.getProperty("user.dir") + "/junmo-generator/src/main/java") // 指定输出目录
                                .commentDate("yyyy-MM-dd") // 注释日期
                                .disableOpenDir(); // 禁止打开输出目录
                    })
                    .packageConfig(builder -> {
                        builder.parent("com.junmo.platform") // 设置父包名
                                .moduleName("") // 设置父包模块名
                                .pathInfo(Collections.singletonMap(OutputFile.xml,
                                        System.getProperty("user.dir") + "/junmo-model/src/main/resources/mapper")); // 设置mapperXml生成路径
                    })
