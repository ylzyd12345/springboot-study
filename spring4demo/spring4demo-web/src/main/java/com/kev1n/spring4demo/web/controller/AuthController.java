...
import com.kev1n.spring4demo.web.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<AuthService.AuthResult> login(
    ...
    public ResponseEntity<AuthService.AuthResult> register(
        ...
        AuthService.AuthResult result = authService.register(username, password, email, realName);
    ...
    public ResponseEntity<AuthService.AuthResult> refreshToken() {
        log.info("刷新Token请求: {}", StpUtil.getLoginId());
        AuthService.AuthResult result = authService.refreshToken();
    ...
    public ResponseEntity<AuthService.UserDTO> getCurrentUser() {
        String userId = StpUtil.getLoginId().toString();
        log.info("获取当前用户信息: {}", userId);
        
        AuthService.UserDTO user = authService.getCurrentUser();
        if (user != null) {
    ...
    public ResponseEntity<AuthService.AuthResult> changePassword(
        ...
        AuthService.AuthResult result = authService.changePassword(oldPassword, newPassword);
